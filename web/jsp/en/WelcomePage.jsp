            ...
            <div id="divSuggestions" class="suggestions" style='display: table'>
                <form action="CineticServlet2" name="y" method="post">
                    <table class="table" style="width: 500px; height: 400px;" >
                        ...
                        <tr>
                            <td align="center"><div onclick="schickenX(<%=randiList.get(1)%>)"><img border="0" src="res/<%=movieList.get(randiList.get(1)).getPicture()%>.jpg" alt="<%=movieList.get(randiList.get(1)).getTitleEnglish()%>" style="width:120px"/></div></td>
                            <td align="center"><div onclick="schickenX(<%=randiList.get(2)%>)"><img border="0" src="res/<%=movieList.get(randiList.get(2)).getPicture()%>.jpg" alt="<%=movieList.get(randiList.get(2)).getTitleEnglish()%>" style="width:120px" /></div></td>
                            <td align="center"><div onclick="schickenX(<%=randiList.get(3)%>)"><img border="0" src="res/<%=movieList.get(randiList.get(3)).getPicture()%>.jpg" alt="<%=movieList.get(randiList.get(3)).getTitleEnglish()%>" style="width:120px" /></div></td>
                        </tr>
                        <tr>
